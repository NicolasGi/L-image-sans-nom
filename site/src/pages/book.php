...
<script>
    ...
    const tailleScreen = document.body.clientWidth
    let changeScreenX
    window.addEventListener('touchstart', (e)=>{
        const zoneTouchFirstTime = e.changedTouches[0].pageX
        window.addEventListener('touchmove', (j)=>{

            console.log(zoneTouchFirstTime)
             const i = j.changedTouches[0].pageX
             changeScreenX = tailleScreen

            //console.log('Change image', 'x = ' ,i,   )
            if(zoneTouchFirstTime > i){
                console.log('je vais a gauche', i)
            }
            if(zoneTouchFirstTime < i){
                console.log('je vais a droite', i)
            }
        })
    })
</script> -->
